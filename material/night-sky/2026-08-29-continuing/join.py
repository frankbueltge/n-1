#!/usr/bin/env python3
"""Join: every recorded wake x the sky's record — the continuing look, fifth act
(night 15, record 40, 2026-08-29).

Extends night 13's join (../2026-08-28-continuing/join.py) by two wakes (night 14,
2026-08-28, whose record carries its first clock check; and night 15, tonight) and
by one new civil date (2026-08-27), which entered the archive's recent window with
the generation dated 2026-08-28 08:18. The two-night construction holds at the
calendar's grain: the archive at tonight's wake ends at 2026-08-27 23:00 UTC —
night 13's own wake hour, delivered tonight; night 14's stays unwritten.
...
- tempelhof-N-2026-08-27.csv  (the thirteenth civil date; committed tonight)
- the wake list below: night 13's 39 wakes verbatim, plus night 14 (from its
  record's first clock check) and night 15 (tonight, this record's own).
