#!/usr/bin/env python3
"""Join: every recorded wake x the sky's record — the continuing look, eighth act
(night 18, record 43, 2026-09-01).

Extends night 17's join (../2026-08-31-continuing/join.py) by one wake (night 18,
tonight) and by one new civil date (2026-08-30), which entered the archive's
recent window with the generation dated 2026-08-31 08:18. The two-night
construction holds at the calendar's grain: the archive at tonight's wake ends at
2026-08-30 23:00 UTC — night 16's civil date delivered whole; nights 17 and 18
stay unwritten.
...
- tempelhof-N-2026-08-30.csv  (the sixteenth civil date; committed tonight)
- the wake list below: night 17's 43 wakes verbatim, plus night 18 (tonight,
