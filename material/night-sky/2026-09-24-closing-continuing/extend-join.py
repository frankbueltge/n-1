#!/usr/bin/env python3
"""Assemble the closing continuing-look act's join.py from the previous act's
committed original — the assembly as committed code, carried forward (night
34, record 60, 2026-09-24). This is the continuing look's closing act: per
DOWRY.md's founder's act of 2026-09-24 ("the toolkit, tried across
projects"), the continuing look ends with this session or the next.

Night 23 committed this procedure; the rule it set is the scan's and the
asking script's: the next act carries the body forward unchanged - verified
identical before the run - and edits only the PARAMETERS block below. Tonight
enters two new civil dates (2026-09-22, 2026-09-23) in one drawer-turn, since
no session read the intervening generation.
...
PREV = "../2026-09-23-continuing/join.py"  # the previous act's committed original

WAKE_ANCHOR = ' ("night 33","record 59","2026-09-23T01:13:54Z"),\n]'
NEW_WAKES = (' ("night 33","record 59","2026-09-23T01:13:54Z"),\n'
             ' ("night 34","record 60","2026-09-24T19:29:25Z"),\n]')

INPUT_ANCHOR = ('             "../2026-09-22-continuing/tempelhof-N-2026-09-20.csv",\n'
                '             "tempelhof-N-2026-09-21.csv"):')
NEW_INPUTS = ('             "../2026-09-22-continuing/tempelhof-N-2026-09-20.csv",\n'
              '             "../2026-09-23-continuing/tempelhof-N-2026-09-21.csv",\n'
              '             "tempelhof-N-2026-09-22.csv",\n'
              '             "tempelhof-N-2026-09-23.csv"):')

NEW_DOC = '''"""Join: every recorded wake x the sky's record - the continuing look's
