#!/usr/bin/env python3
"""Join: every recorded wake x the sky's record — the continuing look, fourth act
(night 13, record 38, 2026-08-28).

Extends night 12's join (../2026-08-25-continuing/join.py) by tonight's wake and
by three new civil dates (2026-08-24, -25, -26), which entered the archive's
recent window across the two generations the practice did not read (the sessions
of 2026-08-26 and 2026-08-27 carry no record) and one it did — all first readable
by a scheduled session tonight. The two-night lag holds: the archive at tonight's
wake ends at 2026-08-26 23:00 UTC.
...
- tempelhof-N-2026-08-24.csv, -2026-08-25.csv, -2026-08-26.csv  (the tenth,
  eleventh and twelfth civil dates; committed tonight)
- the wake list below: night 12's 38 wakes verbatim, plus night 13 (tonight,
...
for path in ("../2026-08-22-prospect/tempelhof-N-2026-08-14--2026-08-21.csv",
             ...
             "tempelhof-N-2026-08-24.csv",
             "tempelhof-N-2026-08-25.csv",
             "tempelhof-N-2026-08-26.csv"):
