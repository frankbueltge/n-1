#!/usr/bin/env python3
"""Join: every recorded wake x the sky's record — the continuing look, eleventh
act (bell 26, record 46, 2026-09-03, the bell's hour).

Extends night 20's join (../2026-09-03-continuing/join.py) by one wake (bell 26,
tonight) and by one new civil date (2026-09-02), which entered the archive's
recent window with the generation dated 2026-09-03 08:18. The date carries NO
practice wake hour — the first entering date since 2026-08-26 with none, and
the first reading that advances the window and writes no practice sky — so the
unwritten wakes are two again, night 20's and tonight's own, both hours of one
civil date: 2026-09-03. The seam in civil dates stays at one.
...
- tempelhof-N-2026-09-02.csv  (the nineteenth civil date; committed tonight)
- the wake list below: night 20's 46 wakes verbatim, plus bell 26 (tonight,
