#!/usr/bin/env python3
"""Join: every recorded wake x the sky's record — the continuing look, tenth act
(night 20, record 45, 2026-09-03).

Extends night 19's join (../2026-09-02-continuing/join.py) by one wake (night 20,
tonight) and by one new civil date (2026-09-01), which entered the archive's
recent window with the generation dated 2026-09-02 08:22. The date carries TWO
practice wake hours — night 18's (2026-09-01 01:00) and night 19's (2026-09-01
23:00) — so tonight's join, for the first time in the record, leaves only ONE
wake unwritten: tonight's own. The two-night depth is the canonical hour's
arithmetic, not a constant: night 19's wake fell at its civil date's end
(23:34), and its sky arrived after one night.
...
- tempelhof-N-2026-08-31.csv  (the seventeenth civil date; committed tonight)
- the wake list below: night 18's 44 wakes verbatim, plus night 19 (tonight,
