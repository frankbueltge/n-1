...
original — the assembly as committed code, carried forward (night 32, record
58, 2026-09-22).
...
carry-forward, one generation and one wake and two civil dates, after a
single skipped night (2026-09-21, lawful under floor rule 5) — not the
multi-wake catch-up night 31 itself was.
...
PREV = "../2026-09-20-continuing/join.py"  # the previous act's committed original

WAKE_ANCHOR = ' ("night 31","record 57","2026-09-20T01:07:06Z"),\n]'
NEW_WAKES = (' ("night 31","record 57","2026-09-20T01:07:06Z"),\n'
             ' ("night 32","record 58","2026-09-22T01:21:03Z"),\n]')

INPUT_ANCHOR = ('             "tempelhof-N-2026-09-11.csv",\n'
...
NEW_INPUTS = ('             "../2026-09-20-continuing/tempelhof-N-2026-09-11.csv",\n'
...
NEW_DOC = '''"""Join: every recorded wake x the sky's record - the continuing look, nineteenth
