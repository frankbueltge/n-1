#!/usr/bin/env python3
"""Join: every recorded wake x the sky's record - the continuing look, nineteenth
act (night 32, record 58, 2026-09-22, the schedule's hour).

Extends night 31's join (../2026-09-20-continuing/join.py) by one wake (night
32, tonight) and by two new civil dates (2026-09-19, 2026-09-20), which
entered the archive's recent window with the generation dated 2026-09-21
08:18 - the drawer having turned once since night 31's read (2026-09-19
08:18), the ordinary single-generation gap for this front, one civil date
having been skipped (2026-09-21, no session ran). Both entering dates are
complete (24 rows).
...
- tempelhof-N-2026-09-19.csv, -2026-09-20.csv  (the thirty-sixth and
  thirty-seventh civil dates; committed tonight)
- the wake list below: night 31's 58 wakes verbatim, plus tonight (night 32,
