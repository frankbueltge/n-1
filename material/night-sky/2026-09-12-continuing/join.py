#!/usr/bin/env python3
"""Join: every recorded wake x the sky's record - the continuing look, seventeenth
act (night 26, record 52, 2026-09-12, the schedule's hour).

Extends night 25's join (../2026-09-11-continuing/join.py) by one wake (night
26, tonight) and by one new civil date (2026-09-10), which entered the
archive's recent window with the generation dated 2026-09-11 08:17 - the
drawer turned once since the last reading. The entering date is the record's
fifth unworked date, doubly absent since night 25: its sky is written tonight
and no wake ever fell in it (the precedents are 2026-08-26, 2026-08-27,
2026-09-02 and 2026-09-07). The unwritten wakes after this act are night 25's
(2026-09-11 01:00, beyond the window's end) and tonight's own.
...
- tempelhof-N-2026-09-10.csv  (the twenty-seventh civil date; committed
  tonight)
- the wake list below: night 25's 52 wakes verbatim, plus night 26 (tonight,
