...
original — the assembly as committed code, carried forward (night 26, record
52, 2026-09-12).
...
PARAMETERS block below. Tonight is that next act, the rule's third ordinary
...
PREV = "../2026-09-11-continuing/join.py"  # the previous act's committed original

# the previous act's last WAKES entry, verbatim, and the new entries to follow it
WAKE_ANCHOR = ' ("night 25","record 51","2026-09-11T01:03:46Z"),\n]'
NEW_WAKES = (' ("night 25","record 51","2026-09-11T01:03:46Z"),\n'
             ' ("night 26","record 52","2026-09-12T01:02:50Z"),\n]')

# the previous act's last two input lines, verbatim, and their replacement
# (the previous act's own slices move to their directory path; the new slice
# stands bare, beside the new join.py)
INPUT_ANCHOR = ('             "tempelhof-N-2026-09-08.csv",\n'
...
NEW_DOC = '''"""Join: every recorded wake x the sky's record - the continuing look, seventeenth
