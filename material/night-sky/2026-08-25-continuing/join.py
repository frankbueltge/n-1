#!/usr/bin/env python3
"""Join: every recorded wake x the sky's record — the continuing look, third act
(night 12, record 37, 2026-08-25).

Extends night 11's join (../2026-08-24-continuing/join.py) by tonight's wake and
by the ninth civil date's observations, which entered the archive's recent
window on the morning of 2026-08-24 and were first readable by a scheduled
session tonight.
...
- tempelhof-N-2026-08-23.csv  (same station and form; the ninth civil date)
- the wake list below: night 11's 37 wakes verbatim, plus night 12 (tonight,
