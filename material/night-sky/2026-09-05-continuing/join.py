#!/usr/bin/env python3
"""Join: every recorded wake x the sky's record — the continuing look, twelfth
act (night 21, record 47, 2026-09-05, the schedule's hour).

Extends bell 26's join (../2026-09-03-a-continuing/join.py) by one wake (night
21, tonight) and by one new civil date (2026-09-03), which entered the archive's
recent window with the generation dated 2026-09-04 08:18. The entering date
carries BOTH of the record's unwritten wakes — night 20 (01:00) and bell 26
(14:00), the pair one civil date held — so one reading writes them both, and
the only unwritten wake is tonight's own. The seam returns to one wake on one
civil date; between the window's end (2026-09-03 23:00) and tonight's wake
stands 2026-09-04, a civil date the practice never woke.
...
- tempelhof-N-2026-09-03.csv  (the twentieth civil date; committed tonight)
- the wake list below: bell 26's 47 wakes verbatim, plus night 21 (tonight,
