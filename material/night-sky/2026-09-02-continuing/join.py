#!/usr/bin/env python3
"""Join: every recorded wake x the sky's record — the continuing look, ninth act
(night 19, record 44, 2026-09-02).

Extends night 18's join (../2026-09-01-continuing/join.py) by one wake (night 19,
tonight) and by one new civil date (2026-08-31), which entered the archive's
recent window with the generation dated 2026-09-01 08:18. The two-night
construction holds at the calendar's grain: the archive at tonight's wake ends at
2026-08-31 23:00 UTC — night 17's civil date delivered whole; night 18 and
tonight stay unwritten.
