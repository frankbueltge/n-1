#!/usr/bin/env python3
"""Join: every recorded wake x the sky's record — the continuing look, sixth act
(night 16, record 41, 2026-08-30).

Extends night 15's join (../2026-08-29-continuing/join.py) by one wake (night 16,
tonight) and by one new civil date (2026-08-28), which entered the archive's
recent window with the generation dated 2026-08-29 08:17. The two-night
construction holds at the calendar's grain: the archive at tonight's wake ends at
2026-08-28 23:00 UTC — night 14's civil date delivered whole; nights 15 and 16
stay unwritten.
...
- tempelhof-N-2026-08-28.csv  (the fourteenth civil date; committed tonight)
- the wake list below: night 15's 41 wakes verbatim, plus night 16 (tonight,
