#!/usr/bin/env python3
"""Join: every recorded wake x the sky's record - the continuing look, thirteenth
act (night 22, record 48, 2026-09-06, the schedule's hour).

Extends night 21's join (../2026-09-05-continuing/join.py) by one wake (night
22, tonight) and by one new civil date (2026-09-04), which entered the archive's
recent window with the generation dated 2026-09-05 08:17. The entering date is
one of the record's three unworked civil dates - no session woke in it - and its
sky enters carrying no wake hour: the date the twelfth act called doubly absent
is now singly absent, its sky written, and no wake will ever stand in it. The
unwritten pair returns on two civil dates: night 21's hour (2026-09-05 01:00)
stands two hours beyond the window's end, and tonight's own waits further.
...
- tempelhof-N-2026-09-04.csv  (the twenty-first civil date; committed tonight)
- the wake list below: night 21's 48 wakes verbatim, plus night 22 (tonight,
